  ...
  @Component({
    selector: 'app-user-otp-page',
    templateUrl: './user-otp-page.component.html',
    styleUrls: ['./user-otp-page.component.css']
  })
  export class UserOtpPageComponent implements OnInit {
    timerInterval: any;
    counter: number = 59;
    otpPattern = /^[0-9]+$/;
